...
const prernaBasePlan = {
  ...
  Saturday: {
    breakfast: { items: "2 eggs bhurji (1tsp oil), 1 multigrain bread, 1 scoop whey + creatine shake" },
    lunch: { items: "100g grilled chicken strips, lettuce, arugula, cucumber, cherry tomato, 1tbsp olive oil dressing" },
    dinner: null, // eat out
  },
  Sunday: {
...
const mohitBasePlan = {
  ...
  Saturday: {
    breakfast: { items: "2 eggs bhurji (1tsp oil), 1 multigrain bread, 2 scoops whey + thoda milk + 1 banana" },
    lunch: { items: "100g grilled chicken, lettuce, arugula, cucumber, tomato, 1tbsp olive oil dressing, 1 roti" },
    dinner: null, // eat out
  },
  Sunday: {
